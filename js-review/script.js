...
const summary = `${title} is a book, yo, ${4 + 2}, a ${pages}-page long book, was written by ${author} in ${publicationDate.split("-")[0]}.The book has ${hasMovieAdaptation ? "" : "not"} been adapted as a movie`
summary
...
const sortedByPages = books.slice().sort((a, b) => b.pages - a.pages).map(book => ({ title: book.title, pages: book.pages }))
sortedByPages
